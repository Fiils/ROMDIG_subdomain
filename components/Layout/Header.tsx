        ...
        <div>
            ...
            <div className={`${styles.container} ${menu ? styles.fullwidth : ''}`}>
                ...
                <div className={`${styles.sidemenu} ${menu ? styles.open_menu : styles.close_menu} ${border ? styles.bb_none : ''}`}>
                    <ul>
                        <a href='/statistics'><a onClick={() => setMenu(false)}><li>Statistici</li></a></a>
                        <a href='/manage-mod'><a onClick={() => setMenu(false)}><li>Gestionare moderatori*</li></a></a>
                        <a href='/create-mod'><a onClick={() => setMenu(false)}><li>Creare moderatori</li></a></a>
                        ...
                        {subSec !== null && 
                            <div className={`${styles.sub_sec} ${subSec ? styles.open_sec : styles.close_sec }`}>
                                <a href='/set-status/p1'><a onClick={() => setMenu(false)}><li className={styles.first}>Setare Status</li></a></a>
                                <a href='/posts/p1'><a onClick={() => setMenu(false)}><li>Toate</li></a></a>
                                <a href='/reported-posts'><a onClick={() => setMenu(false)}><li className={styles.last}>Raportate</li></a></a>
                            </div>
                        }
                        <a href='/reported-comments'><a onClick={() => setMenu(false)}><li>Comentarii raportate</li></a></a>
                        <a href='/registration-forms'><a onClick={() => setMenu(false)}><li>Cereri de înregistrare</li></a></a>
                    </ul> 
                </div>
                }
            </div>
